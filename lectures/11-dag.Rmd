...
We can see with DAG models that we should be **controlling for constructs that create forks** such that it **causes both our X and Y variable**. These constructs are known as _**confounds**_, or constructs that represent common causes of our variables of interest. 
