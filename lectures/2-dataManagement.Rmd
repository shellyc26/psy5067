...
## Today's Activity is Error Tight by Julia Strand

- **Step 1:** for each of the 3 research stages (you should have received an email from me about which group you are in and which research stage you've been assigned), **talk about what _you_ do in your lab for this stage of the research process.**

- **Step 2: The other 2 students in your group should now provide feedback on where errors might arise in your research phase. That is, your peers are providing an outside opinion on what are possibly weak spots in your systems.**

- **Step 3: As a trio, discuss what you can do if you _do_ find an error**
...
- There should be a response for steps 1, 2, and 3 for *all 3* of the research stages. 9 blurbs!
