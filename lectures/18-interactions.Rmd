...
From 100 simulations each, estimates of the model parameter $\beta_{XZ}$ the moderator or interaction effect equaled 0.944 and 1.175 for the field studies and experiments, respectively.
```{r}
set.seed(0305)
```
...
What if you ran a linear regression and looked at the diagnostics?
]
...
<img src="images/interactions pic.jpeg", width = "35%">  
