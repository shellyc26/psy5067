...
Twoway ANOVA
- Model Comparison approach introductin
- t-tests, oneway ANOVA

--

## This time
- What happens when 2 variables impact each other (not only impact the dependent variable)?
...
The null hypothesis is that these factors do NOT dependent on one another. 
...
1) There is a main effect of age; the means of age groups are not equal, regardless of problem type

2) There is a main effect of problem type; the means of normal vs. tricky math problems are not equal, regardless of age
