...
#### What do we do typically do in Psychology?

---
class: inverse, center, middle


# How far have we come in the past 10 years? 20 years? 30 years? 
...
Yarkoni & Westfall (2017) argue that we should spend more time creating predictive models

At the very least, maybe there are some lessons we can take away from the ML world that can potentially help us
...
> How might this work in regression land? 
...
We will hear more of this from Josh Oltmanns 4/9. 
...
- ML classes in CS or SDS department
...
.tiny[Following slides courtesy of Dennis Barbour]
...
![](images/of2.png)
.small[M = parameters, red = line we are fitting, green = "truth"]
--
.small[**Why _shouldn't_ we use all 9 parameter?**]

---
### Why not use all 9 parameters? 
...
.small[Underfitting means we can't capture a relationship at all -- not as big of a problem for us]
...
If you're going hard with ML, use `tidymodels` or Python. See the grad student resources on our website for tools to help you learn both.
...
.tiny[Least Absolute Shrinkage and Selection Operator]
...
```{r, fig.height=5}
plot(lasso.mod, xvar = "lambda", label = TRUE, cex.lab = 1.5)
```
...
Qualitative Methods with Dr. Seanna Leath
