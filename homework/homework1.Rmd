...
7. In #2, the $t$-test output gives you a confidence interval for the difference between the two groups. Using the dummy coded summary output, calculate this same confidence interval. Interpret the confidence interval in the context of this model.  
