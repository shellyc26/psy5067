...
**NOTE: Slides edited on 2/18 to clarify notation. Semi-partial and partial correlations will be denoted as _sr_ or _pr_. If you see _sr^2_ or _pr^2_, it means that the semi-partial and partial correlations are actually squared**
---
...
.small[Notation: $R^2_{Y.12}$ is your standard $R^2$ -- variance explained in what is before the dot by what is after the dot. *"Variance exlained in Y by X1 and X2"*]
---
...
???
the latter is true bc you've removed variance in y...so there's no way for it to be true. specificlaly, you've removed c
